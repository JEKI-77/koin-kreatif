                  ...
                  <div className=" flex flex-col gap-4 justify-center items-center mt-8">
                    {loading ? (
                      ...
                      <button
                        ...
                        type="submit"
                        className="text-white inline-flex items-center bg-cyan-600 hover:bg-cyan-500focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center "
                      >
                        Update
                      </button>
                    )}
